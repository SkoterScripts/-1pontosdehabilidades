...
local NpcOrder = {135,136,183,64,63,52,53,54,162,163};
local IgnoredNpcs = {};
...
local NpcOrderPorcos = {148,149,75,74,109,110,171,172,57,58,167,168};
local IgnoredPorcos = {};
...
local NpcOrderTartarugas = {33,32,44,43,47,46,99,100,118,119,12,11,13,14};
...
local NpcOrderHDC = {88,89,142,143,179,180,122,123,114,115};
local IgnoredHDC = {};
...
local NpcOrderAranha = {147,30,31,187,169,170,175,190};
...
local NpcOrderMamute = {174,192,29,91,79,72};
...
local NpcOrderPlantas = {107,120,164,166,28,8};
...
local NpcOrderMago = {37,38,197,198};
local IgnoredMago = {};
...
local NpcOrderEspartano = {155,156,157,19,191,34,71};
...
local NpcOrderCeifador = {138,158,159,42,55,73,96,45,140};
...
local NpcOrderAnjo = {128,137,139,184,194,3,90,98};
local IgnoredAnjo = {};
...
local NpcOrderCowboy = {152,153,26,27,86,87,146,145,23,22,61,62};
local IgnoredCowboy = {};
...
local NpcOrderFantasma = {101,102,195,196,69,70,24,25,35,36,67,68};
...
local NpcOrderVigiadototem = {10,185,186,9,84,85,199,200,134,133};
...
local NpcOrderMumia = {181,182,66,65,1,2,92,93,17,16,188,189};
local IgnoredMumia = {};
